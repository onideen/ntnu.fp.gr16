...
public class CalendarService {
	...
	private void updateEvent(Event e) {
		executeQuery("UPDATE Hendelse SET dato = '" + e.getDate() + "', "
				+ "starttid = '" + e.getStartTime() + "', " + "sluttid = '"
				+ e.getEndTime() + "', " + "beskrivelse = '"
				+ e.getDescription() + "'," + "type = '" + e.getType() + "', "
	...
	public void saveEvent(Event e) {
		String s = "INSERT INTO Hendelse(dato, starttid, sluttid, beskrivelse, type, ansvarlig) values ('"
				...
				+ e.getDescription()
				+ "', '"
				+ e.getType().toString() + "', '" + e.getResponsible() + "');";
		executeQuery(s);
	}
	...
	public void receiveData(ServerRequest sr) throws IllegalArgumentException, IllegalAccessException, InvocationTargetException
	{
