...
public class CalendarService implements ConnectionListener, ReceiveMessageWorker.MessageListener {
    ...
    public void updateEvent(Event e) {
        ...
        try {
            ...
            for (String attendee : e.getAttendees()) {
                ...
                Message m = new Message(boss.getName() + " har endret m�tet. M�tet er n� " + e.getDateString() + ". M�tet gjelder: " + e.getDescription(), Message.Type.Invitation, attendee, e.getEid());
                saveMessage(m);
            }
    ...
    public int saveEvent(Event e) {
        ...
        try {
            ...
            for (String attendee : e.getAttendees()) {
                ...
                Person boss = getPerson(e.getResponsible());
                Message m = new Message(boss.getName() + " har kalt inn til m�te " + e.getDateString() + ". M�tet gjelder: " + e.getDescription(), Message.Type.Invitation, attendee, e.getEid());
                saveMessage(m);
            }
