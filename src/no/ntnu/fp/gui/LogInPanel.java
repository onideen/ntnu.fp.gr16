	...
	private void initGUI() {
		try {
			...
			this.setLayout(null);
			{
				...
				logInPanelLayout.rowWeights = new double[] {0.1, 0.1, 0.1};
				logInPanelLayout.rowHeights = new int[] {7, 7, 7};
				logInPanelLayout.columnWeights = new double[] {0.1, 0.1};
				logInPanelLayout.columnWidths = new int[] {7, 7};
