 ...
 */
public class ConnectionImplOld extends AbstractConnection {
     ...
     */
    public ConnectionImplOld(int myPort) {
        this.myPort = myPort;
    ...
    public Connection accept() throws IOException, SocketTimeoutException {
        ...
        ConnectionImplOld connection = new ConnectionImplOld(myPort);
    ...
    public void close() throws IOException {
        if(disconnectRequest == null) {
            ...
            try {simplySendPacket(datagram); new Object().wait(1000);}
            catch (ClException e) {throw new IOException("FIN SEND FAIL!");}
